...
const AppliedJob = ({ appliedJob }) => {
    ...
    const { id, logo, job_title, company_name, remote_or_onsite, contact_information, educational_requirements, experience, job_description, job_responsibility, job_type, location, salary } = appliedJob;

    return (
        <div>
            <div className="border-2 h-full border-[#dacbff] rounded-lg py-5 mb-5 px-3 text-left ps-8 flex justify-between items-center">
                <div className="flex gap-10">
                    <div className="shadow-lg hover:shadow-2xl p-9 rounded-lg">
